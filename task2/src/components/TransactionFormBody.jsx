...
const TransactionFormBody = ({ control, register, errors }) => (
  <main className='flex flex-col px-4 py-6 gap-4'>
    ...
    <InputNumber label="Số lượng (lít)" name="soLuong" register={register} error={errors.soLuong?.message} />
    <SelectColumn register={register} error={errors.tru?.message} />
    <InputNumber label="Doanh thu" name="doanhThu" register={register} error={errors.doanhThu?.message} />
